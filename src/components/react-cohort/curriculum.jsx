  ...
  return (
    <div className="mx-10 md:mx-16 mt-32">
      ...
      <div>
        ...
        <Tab.Group>
          <Tab.List className="md:flex lg:space-x-3  bg-slate-800 p-3 border border-slate-500">
            {Object.keys(categories).map((category) => (
              <Tab
                key={category}
                className={({ selected }) =>
                  classNames(
                    "text-left lg:text-center w-full text-xl uppercase p-3 font-medium leading-5",
                    selected
                      ? "text-cyan-300"
