      ...
      <div className="dmmt__right">
        ...
        <div className="dmmt__content-container">
          <p className="dmmt__content">
            <i>Don't Make Me Think: A Common Sense Approach to Web Usability</i>, authored by Steve Krug, is a book that provides insight into how usability and user experience can be improved on the web.<br />
